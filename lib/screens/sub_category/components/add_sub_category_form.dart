                    ...
                    child: Consumer<SubCategoryProvider>(
                      builder: (context, subCatProvider, child) {
                        ...
                        return CustomDropdown<Category>(
                          hintText: 'Category',                          // ✅ به‌جای labelText
                          initialValue: subCatProvider.selectedCategory, // ✅ به‌جای value
                          items: sorted,                                 // ✅ خود لیست Category
                          displayItem: (c) => c.name ?? '-',             // ✅ متن نمایش آیتم
                          onChanged: (val) {
