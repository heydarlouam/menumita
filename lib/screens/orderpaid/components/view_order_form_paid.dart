...
class _OrderSubmitFormPaidState extends State<OrderSubmitFormPaid> {
      ...
      child: Container(
        ...
        child: Form(
          ...
          child: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              // ✅ موبایل: زیرهم | تبلت/دسکتاپ: کنار هم
              if (isMobile) ...[
                formRow(
                  context,
                  'نام:',
  ...
  // ✅ 3 باکس دارای border => width: double.infinity
  Widget addressSection(Order? order, BuildContext context) {
    return Container(
      width: double.infinity, // ✅ EXPAND
      margin: const EdgeInsets.only(top: 20),
      padding: const EdgeInsets.all(defaultPadding),
      decoration: BoxDecoration(
        color: secondaryColor,
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Expanded(child: Text(' ${item.note} ')), // ✅ جلوگیری از overflow
                ],
              ),
            ],
          ),
  ...
  Widget actionButtons(BuildContext context, OrderPaidProvider op, bool isMobile) {
    if (isMobile) {
      return Column(
        children: [
          SizedBox(
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              child: AnimatedSwitcher(
                ...
                transitionBuilder: (child, anim) => FadeTransition(opacity: anim, child: child),
                child: op.isSubmitting
                    ? const SubmissionSpinner(key: ValueKey('order_paid_loading'))
                    : const Text(
                  'بروزرسانی سفارش',
                  style: TextStyle(color: Colors.white),
                  key: ValueKey('order_paid_submit_text'),
